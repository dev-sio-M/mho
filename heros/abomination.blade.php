...
<li><strong>Affiliation(s) : </strong>Ancien membre de l’équipage du vaisseau spatial Andromède, ancien agent du Maître des Galaxies, du général Thaddeus Ross et de M.O.D.O.K, allié des Abominations/Oubliés ;</li>
<li><strong>Ennemi(s) récurrent(s) : </strong><a href="hulk.html" style="color: orange;">Hulk</a> , le<a href="leader.html" style="color: orange;"> Leader</a>, <a href="redHulk.html" style="color: orange;">Red Hulk</a>, <a href="hulkbuster.html" style="color: orange;">Hulkbuster</a>.</li>
<br>

<h2><u>Histoire</u></h2>
<p class="centrer">
Emil Blonsky, était un agent du KGB (service de renseignement soviétique) qui a été chargé de traquer Hulk, le géant vert aux pouvoirs surhumains. Dans sa quête pour surpasser Hulk, Blonsky s'est exposé à une version expérimentale du sérum du Super-Soldat, similaire à celui qui a créé <a href="captainAmerica.html" style="color: orange;">Captain America</a>. Cependant, les effets du sérum combinés à une dose de rayons gamma ont transformé Blonsky en une créature monstrueuse connue sous le nom de l'Abomination.<br><br>
...
Au fil des années, l'Abomination a affronté Hulk à de nombreuses reprises, provoquant des combats dévastateurs et destructeurs. Il a également croisé le chemin d'autres héros Marvel tels que <a href="thor.html" style="color: orange;">Thor</a>, <a href="ironMan.html" style="color: orange;">Iron Man</a> et les <a href="avengers.html" style="color: orange;">Avengers</a>. Dans certains récits, l'Abomination a cherché à s'emparer du pouvoir de Hulk pour devenir le monstre le plus puissant de l'univers.<br><br>
