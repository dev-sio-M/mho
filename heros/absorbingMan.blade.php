...
<li><strong>Famille : </strong>Mary Mac Pherran (<a href="titania.html" style="color: orange;">Titania</a>, épouse), Rockwell Davis (Hi-Lite, cousin), Jerry Sledge (Muraille, fils) ;</li>  
...
<li><strong>Ennemi(s) récurrent(s) : </strong><a href="thor.html" style="color: orange;">Thor</a>, <a href="hulk.html" style="color: orange;">Hulk</a>, les <a href="avengers.html" style="color: orange;">Avengers</a>, <a href="daredevil.html" style="color: orange;">Daredevil</a>, <a href="spiderMan.html" style="color: orange;">Spider-Man</a>.</li>
<br>


<h2><u>Histoire</u></h2>
<p class="centrer">
Crusher Creel née à new York, était un criminel de bas niveau qui a eu un destin singulier lorsqu'il a accepté de participer à une expérience scientifique. Cette expérience impliquait la prise d'un sérum spécial qui lui a conféré la capacité unique d'absorber les propriétés physiques de tout matériau auquel<br> il était exposé par simple contact.<br><br>
