...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/thanos">Thanos</a></li>
    <li><a href="/heros/thing">Thing</a></li>
    <li><a href="/heros/thor">Thor</a></li>
    <li><a href="/heros/titania">Titania</a></li>
    <li><a href="/heros/typhoidMary">Typhoid Mary</a></li><br><br>
  </ul>
</div>
</div>
</body>
