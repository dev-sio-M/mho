...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/ebonyMaw">Ebony Maw</a></li>
    <li><a href="/heros/electro">Electro</a></li>
    <li><a href="/heros/elektra">Elektra</a></li>
    <li><a href="/heros/enchantress">Enchantress</a></li><br><br>
  </ul>
</div>
</div>
</body>
