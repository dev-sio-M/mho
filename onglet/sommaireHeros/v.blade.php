...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/valkyrie">Valkyrie</a></li>
    <li><a href="/heros/venom">Venom</a></li>
    <li><a href="/heros/viper">Viper</a></li>
    <li><a href="/heros/vision">Vision</a></li>
    <li><a href="/heros/vulture">Vulture</a></li><br><br>
  </ul>
</div>
</div>
</body>
