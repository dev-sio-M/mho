...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/iceMan">Ice Man</a></li>
    <li><a href="/heros/invisibleWoman">Invisible Woman</a></li>
    <li><a href="/heros/ironFist">Iron Fist</a></li>
    <li><a href="/heros/ironLad">Iron Lad</a></li>
    <li><a href="/heros/ironheart">Ironheart</a></li><br><br>
  </ul>
</div>
</div>
</body>
