...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/patriot">Patriot</a></li>
    <li><a href="/heros/polaris">Polaris</a></li>
    <li><a href="/heros/professorX">Professor X</a></li>
    <li><a href="/heros/psylocke">Psylocke</a></li>
    <li><a href="/heros/punisher">Punisher</a></li><br><br>
  </ul>
</div>
</div>
</body>
