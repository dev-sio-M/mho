...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <ul>
    <li><a href="/heros/jeff">Jeff</a></li>
    <li><a href="/heros/jessicaJones">Jessica Jones</a></li>
    <li><a href="/heros/jubilee">Jubilee</a></li>
    <li><a href="/heros/juggernaut">Jugernaut</a></li><br><br>
  </ul>
</div>
</div>
</body>
